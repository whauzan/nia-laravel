...
<div class="card">
  <div class="card-body">
    <h2 class="text-center">Tambah Data TV Kabel</h2>

    <!-- Vertical Form -->
    <form class="row g-3" method="POST" action="{{ route("confirm_add_tv_sdm") }}" enctype="multipart/form-data">
        @csrf
      <div class="col-12">
      ...
      <div class="col-12">
        ...
        <input type="text" class="form-control" id="inputPassword4" name="no_hp">
      </div>
      <div class="col-12">
        <label for="inputPassword4" class="form-label">Jenis TV</label>
        <input type="text" class="form-control" id="inputPassword4" name="jenis_tv">
      </div>
      <div class="col-12">
      ...
      <div class="col-12">
        ...
        <input type="text" class="form-control" id="inputAddress" name="roaming_ln">
      </div>
      <div class="col-12">
