        ...
        <div class="card-body">
            <h2 class="text-center">Master Data TV Kabel</h2>
                ...
                <table class="table table-borderless datatable">
                                    ...
                                    <tbody>
                                    @php $i=1 @endphp
                                    @foreach($master_data_tv_kabel_sdm as $s)
                                        <tr>
                                            <td>{{$i++}}</td>
                  ...
                  <div class="text-right">
                   <a href="{{ route("import_tv_sdm") }}"> <button type="submit" class="btn btn-primary" data-toggle="modal">Import Data Excel </button></a></a>
                  </div>
    </div>
    </div>
